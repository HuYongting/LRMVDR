...
class UNet(nn.Module):
    def __init__(self, n_channels=3,dims = [64,128,256,512], n_classes=2, bilinear=False):
        ...
        self.down4 = (Down(dims[3], dims[3]*2 // factor))
        self.up1 = (Up(dims[3]*2, dims[3] // factor, bilinear))
        self.up2 = (Up(dims[3], dims[2] // factor, bilinear))
        self.up3 = (Up(dims[2], dims[1] // factor, bilinear))
        self.up4 = (Up(dims[1], dims[0], bilinear))
